...
public class GridManager : MonoBehaviour
{
    ...
    private void Awake()
    {
        ...
        occupiedCells = new GridFootprint[
            gridWidth,
            gridHeight
        ];
    }
        ...
        GridFootprint footprint)
    {
        ...
        PlacementRule rule =
            footprint.GetComponent<PlacementRule>();

        if (rule != null &&
            !rule.IsPlacementValid(
                bottomLeftCell,
                this))
        {
            return false;
    ...
    public bool CanMoveObjectAlongPath(
